...
_REGISTRANTINFO = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_addr', full_name='RegistrantInfo._addr',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_port', full_name='RegistrantInfo._port',
...
_REGISTERRESP = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_reason', full_name='RegisterResp._reason',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_REGISTRANTINFO.oneofs_by_name['_addr'].fields.append(
  _REGISTRANTINFO.fields_by_name['addr'])
_REGISTRANTINFO.fields_by_name['addr'].containing_oneof = _REGISTRANTINFO.oneofs_by_name['_addr']
_REGISTRANTINFO.oneofs_by_name['_port'].fields.append(
  _REGISTRANTINFO.fields_by_name['port'])
_REGISTRANTINFO.fields_by_name['port'].containing_oneof = _REGISTRANTINFO.oneofs_by_name['_port']
...
_REGISTERRESP.oneofs_by_name['_reason'].fields.append(
  _REGISTERRESP.fields_by_name['reason'])
_REGISTERRESP.fields_by_name['reason'].containing_oneof = _REGISTERRESP.oneofs_by_name['_reason']
